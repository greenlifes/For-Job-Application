## TimelinePlayer
TimelinePlayer is a WYSYWYG skill editing tool, let player can fast editing & preview chatacter action setting in unity timeline, then saved to serialized data which can be play in SequencePlayer.cs
